...
if ( class_exists( 'BP_Group_Extension' ) ) : // Recommended, to prevent problems during upgrade or when Groups are disabled
	...
	class LS_BPFB_Images_Tab_Extension extends BP_Group_Extension {
		...
		function __construct() {
			...
			if ( $bp->groups->current_group ) {
				...
				$this->count_images      = ! empty( $activities_template->activity_count ) ? $activities_template->activity_count : '0';
				$x                       = $this->count_images;
				$this->nav_item_name     = $this->name . ' (<span class="count">' . $x . '</span>)';
		...
		function display( $group_id = null ) {
			...
			<div class="info-group">
				...
				<?php if ( bp_group_is_member() ) : ?>
					<div class="generic-button group-button public"><a href="<?php bp_group_permalink(); ?>#whats-new-form" class="generic-button" id="ls_bpfb_add_image"><?php _e( 'Add New', 'buddypress' ); ?></a></div>
				<?php endif; ?>
